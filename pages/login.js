              ...
              /> */}
                ...
                <div className=" hidden lg:block relative w-0 flex-1">
                    <div className="min-h-screen relative bg-gray-900">
                        <div className="min-h-screen w-full absolute bottom-0 xl:inset-0 xl:h-full">
                            <div className="min-h-screen w-full xl:grid xl:grid-cols-2">
                                <div className="min-h-screen xl:relative xl:col-start-2">
                                    <img
                                        className="min-h-screen w-full object-cover opacity-25 xl:absolute xl:inset-0"

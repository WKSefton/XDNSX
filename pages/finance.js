...
export default function Finance({projects}) {
    ...
    // }, []);
    return (
        <div className="mt-8 max-w-fit mx-auto grid grid-cols-1 gap-6 sm:px-6 lg:grid-flow-col-dense lg:grid-cols-3">
                    ...
                    <div className="bg-white shadow sm:rounded-lg">
                        ...
                        <div className="border-t border-gray-200 px-4 py-5 sm:px-6">
                            <dl className="grid grid-cols-1 gap-x-4 gap-y-8 sm:grid-cols-2">
                                ...
                                <div className="sm:col-span-1">
                                    <dt className="text-sm font-medium text-gray-500">Salary expectation
                                    </dt>

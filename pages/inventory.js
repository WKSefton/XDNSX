    ...
    return (
        <div className="bg-white">
            <div className="max-w-4xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:px-8">
                <h1 className="text-3xl font-extrabold tracking-tight text-gray-900">On Hand</h1>

                <form className="mt-12">
                    <div>
                        <h2 className="sr-only">Items in your Warehouse</h2>
                                        ...
                                        <div>
                                            <div className="flex justify-between sm:grid sm:grid-cols-2">
                                                <div className="pr-6">
                                                    ...
                                                    {product.size ?
                                                        <p className="mt-1 text-sm text-gray-500">{product.size}</p> : null}
                                                </div>
                        ...
                        <div className="bg-gray-50 rounded-lg px-4 py-6 sm:p-6 lg:p-8">
                            ...
                            <div className="flow-root">
                                <dl className="-my-4 text-sm divide-y divide-gray-200">
                                    ...
                                    {/*</div>*/}
                                    <div className="py-4 flex items-center justify-between">
                                        <dt className="text-base font-medium text-gray-900">Asset Total</dt>
